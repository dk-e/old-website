...
const Home: NextPage = () => {
  ...
  return (
    <div
      className="relative col-span-3 row-span-2 rounded-2xl bg-teal-950 p-6 shadow md:col-span-2 md:p-8"
      style={{
    ...
    >
      <Link href="/stats">
        ...
        >
          <h2 className="mb-3 bg-gradient-to-tl bg-clip-text text-xl font-semibold text-transparent text-white md:text-2xl">
            Spotify
          </h2>{" "}
          <br />
          <p>
            <strong>Listening to: {data.spotify.song}</strong>
          </p>
          <p>
            <strong>By: {data.spotify.artist}</strong>
          </p>
          <div className="absolute bottom-0 left-0 right-0 h-[0.35rem] overflow-hidden rounded-full">
            <div
              className="h-[0.35rem] overflow-hidden rounded-full bg-gray-300"
              style={{
